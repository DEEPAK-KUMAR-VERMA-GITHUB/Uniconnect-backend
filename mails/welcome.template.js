        ...
        <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff; margin:20px 0; border-radius:8px; overflow:hidden;">
          ...
          <tr>
            <td style="text-align:center; padding:20px; background:#00489c;">
              <img src="https://res.cloudinary.com/uniconnect/image/upload/f_auto,q_auto/v1/uniconnect/images/b38bfbf1c2aca1a1ec725f67249ac0f2" alt="University App Logo" width="120" style="display:block; margin:0 auto;">
            </td>
          </tr>
          <!-- Greeting -->
          <tr>
