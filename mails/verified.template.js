export const verifiedEmailTemplate = (user) => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
        ...
        <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff; margin:20px 0; border-radius:8px; overflow:hidden;">
          ...
          <tr>
            <td style="padding:30px 40px; font-family:Arial, sans-serif; color:#333333;">
              <h1 style="margin:0 0 10px; font-size:24px;">Hello, ${
                user.fullName
              }!</h1>
              <p style="margin:0 0 20px; font-size:16px; line-height:1.5;">
                We're pleased to inform you that your account as a <strong>${
                  user.role
                }</strong> has been successfully verified by our administration team.
              </p>
              <p style="margin:0 0 20px; font-size:16px; line-height:1.5;">
              ...
              <p style="text-align:center; margin:30px 0;">
                <a href="#" style="background:#00489c; color:#ffffff; padding:12px 24px; text-decoration:none; border-radius:4px; display:inline-block; font-size:16px;">
                  Access Your Account
                </a>
              </p>
